document.addEventListener('DOMContentLoaded', function () {
    ...
    form.addEventListener('submit', function (event) {
        ...
        var users = {
            'admin': {password: 'admin123', role: 'admin', redirect: '/Principal'},
            'alumno': {password: 'alumno123', role: 'alumno', redirect: '../alumno/VentanaPrincipalAlumno.html'},
            'profesor': {password: 'profesor123', role: 'profesor', redirect: '../profesores/principalprofesores.html', name: 'NombreDelProfesor'}
        };
